require './application'
Lunchcramp::Application.initialize!

# Development middlewares
if Lunchcramp::Application.env == 'development'
  ...
  use Rack::Static, :urls => ["/javascripts"], :root => Lunchcramp::Application.root(:public)
end
...
#
run Lunchcramp::Application.routes
